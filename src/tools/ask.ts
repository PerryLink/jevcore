...
import { assertValidBatch, choice, noul, score } from '../primitives.js'
import type { JevService } from '../service.js'
import type { JevQuestion, JsonValue } from '../types.js'
import { asRendered, renderResult, summarize } from './render.js'
...
export const jevAskTool = (service: JevService) =>
  defineTool({
    ...
    description:
      ...
      'judgments the rest of the work branches on â?routing, classifying, scoring, deciding, ' +
      ...
      'tool returns probabilities, not decisions â?apply your own confidence threshold before ' +
