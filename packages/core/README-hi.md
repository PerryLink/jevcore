...
यह जितना बदलता है वह उससे कम है जितना यह वाक्य बताता है, और एक input इसे कभी नहीं पढ़ता: प्रश्न का
`instructions` text। Hash केवल प्रश्न के id और request के state को cover करता है। इसलिए एक ही id और
एक ही state पर अलग-अलग शब्दों में पूछे गए दो प्रश्नों का उत्तर वही आता है, और mock यह नहीं बता सकता
कि किसी prompt के शब्द ठीक हैं या नहीं। घोषित criteria भी hash में नहीं जाते, पर वे उत्तर का आकार
फिर भी तय करते हैं: `choice` उत्तर अपने weights उन labels पर बाँटता है जो आपने घोषित किए, और
`score` उत्तर घोषित levels की संख्या पर। दोनों 0.5 की स्थिर confidence बताते हैं।
[docs/limits.md](docs/limits.md) में बाकी बताया गया है जो offline रास्ता model नहीं करता।
