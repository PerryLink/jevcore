...
| `openRouterBaseURL` | `https://openrouter.ai` | Raiz da API para a rota `openrouter`. A mesma regra |
| `model` | `jev-latest` | Enviado em toda requisição. Na rota OpenRouter, precisa começar com `typesafe/` |
